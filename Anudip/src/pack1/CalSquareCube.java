/*Write a program create 2 interface'Printable'and 'Calculate' and use these 2 interface in 
  2 different classes one will calculate square and another will calculate cube.*/
  package pack1;
